...
**Status:** Build — plan drafted 2026-09-21; FED-01 (seam) + FED-02 (Google) in !169, tag v0.14.0 on merge (v0.13.0 went to !170). Next FED-03 (Facebook); Apple (FED-04) deferred with kitg's launch set.
