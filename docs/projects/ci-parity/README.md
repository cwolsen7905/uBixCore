...
| CP-18 | JS gate: `js-lint` stays advisory — SowingMeJs has 28 eslint errors (unused vars, `svelte/require-each-key`) and 84 svelte-check errors; clean up then drop `allow_failure` | Todo | |
