...
The custom PHPCS sniff `Ubix.Standards.DemandCanonicalPagination` (`php/Ubix/Sniffs/Standards/DemandCanonicalPaginationSniff.php`) enforces that a payload exposing pagination fields does so through a sanctioned base, never a hand-rolled third shape:
