...
abstract class AbstractUbixConcreteClassOrEnumTestCase extends TestCase
{
     ...
     * under a vendor + product root (`Acme\Product\Model`) that decides which
     ...
     *
     * `isInFamily('Acme\Product\Service\Sql\FooService', 'Service\Sql')` is true;
    ...
    /**
     * Test that the class follows uBix standards
     *
    ...
    /**
     * Test that the console command class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the controller class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the Collection class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the DTO class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the HTTP client class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the exception class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the middleware class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the model class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the renderer class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the repository class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    private function testRepositoryClassFollowingUbixStandards(string $className): void
    {
        ...
        //  (`Ubix\Repository\User\…`, `Acme\Product\Repository\User\…`)
        //
        ...
        if ($class->isInterface()) { // Validate repository interface
            ...
            foreach ($class->getInterfaceNames() as $interfaceName) {
                $this->assertTrue(
                    ...
                    'All repository concrete classes must only implement uBixCore repository interfaces but `' . $class->getName() . '` implements `' . $interfaceName . '`',
                );
            ...
            //
            //  Test any uBixCore interfaces implemented
            //
    ...
    /**
     * Test that the service class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the session handler class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the simple cache class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the Slim handler class follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    private function testSlimHandlerClassFollowingUbixStandards(string $className): void
    {
        ...
        $this->assertTrue(
            ...
            'All Slim handler classes must extend the `' . ErrorHandler::class . '` class or another uBixCore Slim handler class but `' . $class->getName() . '` does not',
        );
    ...
    /**
     * Test that the class namespace follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the class name follows uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the class properties follow uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the class constants follow uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the class methods follow uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
    ...
    /**
     * Test that the class dependencies follow uBix standards
     *
     * @param string $className The class to test
     *
     * @return void
