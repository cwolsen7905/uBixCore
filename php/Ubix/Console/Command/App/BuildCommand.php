...
HELP,
    ...
    private function getBuildCommands(): array
    {
        ...
        return [
            'docker image rm -f example.com/k8s/baseimages/nginx-php8-fpm-memcache:latest || true',
            'docker build -f ' . $root . '/Dockerfile_Sandbox -t ubixcore:sandbox ' . $root . '/',
            'docker save ubixcore:sandbox > /tmp/ubixcore_sandbox.tar',
            'microk8s ctr image import /tmp/ubixcore_sandbox.tar',
