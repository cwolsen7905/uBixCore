...
abstract class AbstractCommand extends SymfonyCommand
{
    ...
    private const ASCII_BANNER = <<<'ASCII'
<fg=bright-cyan>██╗   ██╗██████╗ ██╗██╗  ██╗</><fg=bright-magenta>███████╗██╗   ██╗███████╗</>
<fg=bright-cyan>██║   ██║██╔══██╗██║╚██╗██╔╝</><fg=bright-magenta>██╔════╝╚██╗ ██╔╝██╔════╝</>
<fg=bright-cyan>██║   ██║██████╔╝██║ ╚███╔╝ </><fg=bright-magenta>███████╗ ╚████╔╝ ███████╗</>
<fg=cyan>██║   ██║██╔══██╗██║ ██╔██╗ </><fg=magenta>╚════██║  ╚██╔╝  ╚════██║</>
<fg=cyan>╚██████╔╝██████╔╝██║██╔╝ ██╗</><fg=magenta>███████║   ██║   ███████║</>
<fg=cyan> ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═╝</><fg=magenta>╚══════╝   ╚═╝   ╚══════╝</>
<fg=bright-yellow>▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</>
<fg=bright-yellow>▶</> <fg=bright-white>POWERED BY uBixCore</> <fg=gray>·</> <fg=bright-white>ubixsys.com</> <fg=bright-yellow>◀</>
ASCII;
    ...
    /**
     * Display the uBixSys 8-bit banner
     *
     * @param Output $output Symfony output
     *
     * @return void
     */
    protected function displayAsciiBanner(Output $output): void
    {
        $this->displayAscii($output, self::ASCII_BANNER, true);
    }
}
