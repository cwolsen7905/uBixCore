...
final class RecordingApp extends App
{
    ...
    public function __construct(
        protected Logger $logger, // @phpstan-ignore property.onlyWritten (Logger is a required dependency of most uBixCore classes but has not been implemented in this class yet)
    ) {
