 ...
 *
 * Passed to {@see \Ubix\Service\Payment\PaymentProviderInterface::createOneOffCheckout()}.
 *
...
final readonly class OneOffCheckoutRequest implements Dto
{
     ...
     * @param string                $successUrl        Where the provider returns the payer after a completed payment; a host must treat arrival here as "the payer says it worked", never as proof of payment -- only a verified webhook is proof (see {@see \Ubix\Service\Payment\PaymentProviderInterface::verifyWebhook()})
