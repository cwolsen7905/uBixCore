...
/**
 * Data transfer object for the SQL repository options of affiliates
 *
 * @see \Ubix\Repository\Affiliate\AffiliateSqlRepository This DTO is used by the affiliate SQL repository
 * @see \Ubix\Tests\DataTransferObject\SqlRepository\AffiliateOptionsTest PHPUnit test case
 */
final readonly class AffiliateOptions implements Dto
{
    /**
     * Constructor
     *
     * @param ?int    $id           The affiliate's ID (optional) (default: null)
