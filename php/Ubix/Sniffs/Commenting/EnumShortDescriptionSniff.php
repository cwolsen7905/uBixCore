...
/**
 * Ensures that every enum has a PHPDoc with a non-empty short description.
 */
class EnumShortDescriptionSniff implements Sniff
{
    /**
    ...
    public function process(File $phpcsFile, $stackPtr): void
    {
        ...
        if (!$hasDescription) {
            $name = $phpcsFile->getDeclarationName($stackPtr);
            $phpcsFile->addError(
                'Enum %s must have a PHPDoc short description',
                $commentStart,
