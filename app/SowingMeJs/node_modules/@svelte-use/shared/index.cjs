...
function writable(value, start = noop) {
    const s = store.writable(value, start);
    const runs = new Set();
...
function unstore(val) {
    return isReadable(val) ? store.get(val) : val;
}
...
exports.tryGetCurrentComponent = tryGetCurrentComponent;
exports.tryOnDestroy = tryOnDestroy;
