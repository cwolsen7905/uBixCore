import { isClient, isString, noop, toReadable, tryOnDestroy, unstore, writable, promiseTimeout, toWritable } from '@svelte-use/shared';
...
function useStorage(key, initialValue, storage = defaultWindow === null || defaultWindow === void 0 ? void 0 : defaultWindow.localStorage, options = {}) {
    var _a;
    const { listenToStorageChanges = true, window = defaultWindow, onError = (e) => {
        console.error(e);
    }, } = options;
    const rawInit = unstore(initialValue);
                ...
                : typeof rawInit === 'object'
                    ...
                    : Array.isArray(rawInit)
                        ...
                        : !Number.isNaN(rawInit)
                            ? 'number'
                            : 'any';
    const data = toWritable(initialValue);
...
function useTitle(newTitle = null, options = {}) {
    ...
    const title = toWritable((_a = newTitle !== null && newTitle !== void 0 ? newTitle : document === null || document === void 0 ? void 0 : document.title) !== null && _a !== void 0 ? _a : null);
    let oldTitle = document === null || document === void 0 ? void 0 : document.title;
    title.subscribe((t) => {
...
export { StorageSerializers, onClickOutside, useAsyncState, useEventListener, useLocalStorage, useMediaQuery, useMutationObserver, usePreferredDark, useRafFn, useSessionStorage, useStorage, useTitle };
