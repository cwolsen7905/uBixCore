...
<div class="library-page">
	...
	{#if activeTab === 'posts'}
		<div class="empty-state">
			...
			<p class="empty-description">
				Use your library to keep track of everything you publish. Post an update today to kick
				things off.
			</p>
			<button class="create-post-button" on:click={handleCreatePost}> Create a post </button>
		</div>
	{:else if activeTab === 'collections'}
		<div class="empty-state">
			...
			<p class="empty-description">Create collections to organize your posts into categories.</p>
		</div>
	{:else if activeTab === 'drafts'}
		<div class="empty-state">
			...
			<p class="empty-description">Save your work-in-progress posts as drafts to finish later.</p>
		</div>
	{/if}
</div>
