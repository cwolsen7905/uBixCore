...
--
-- Host: db-employee.lan.vsmedia.net    Database: ADSERVER
-- ------------------------------------------------------
...
--
-- Table structure for table `Delivery_Stats`
--
...
CREATE TABLE `Delivery_Stats` (
  ...
  PRIMARY KEY (`datetime`,`zone_id`,`advertiser_id`,`campaign_id`,`banner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `Delivery_Stats_Daily`
--

DROP TABLE IF EXISTS `Delivery_Stats_Daily`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `Delivery_Stats_Daily` (
  ...
  `clicks` int(10) unsigned NOT NULL DEFAULT 0,
  `conversions` int(10) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`date`,`zone_id`,`advertiser_id`,`campaign_id`,`banner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-25 17:34:03
